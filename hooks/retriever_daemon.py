...
def _retriever_main_impl(hook_input: dict, mods: dict,
    ...
    try:
        ...
        if _check_deadline("post_scoring", is_hard=True):
            ...
            _cross_floor_d = 0.12 if _local_chunk_count_d == 0 else (0.18 if _local_sparse_d else 0.25)
        ...
        _cross_floor_f2 = 0.12 if _local_chunk_count_d == 0 else (0.18 if _local_sparse_d else 0.25)
        positive = [(s, c) for s, c in positive
